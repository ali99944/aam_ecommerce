      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl p-8 border border-gray-100 mb-12">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-primary mb-4">التزامنا بحماية خصوصيتك</h2>
        ...
        {/* Data Collection */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary mb-8">البيانات التي نجمعها</h2>
        ...
        {/* How We Use Data */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary mb-8">كيف نستخدم بياناتك</h2>
          <div className="bg-white rounded-xl p-8 border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-bold text-primary mb-4">الأغراض الأساسية</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-primary mb-4">الأغراض الثانوية</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
        ...
        {/* Security Measures */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary mb-8">إجراءات الأمان</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {securityMeasures.map((measure, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-primary mb-2">{measure.title}</h3>
        ...
        {/* User Rights */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary mb-8">حقوقك</h2>
          <div className="bg-white rounded-xl p-8 border border-gray-100">
        ...
        {/* Cookies Policy */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-primary mb-8">سياسة ملفات تعريف الارتباط</h2>
          <div className="bg-white rounded-xl p-8 border border-gray-100">
            <div className="flex items-start gap-4 mb-6">
              <Cookie className="w-6 h-6 text-primary mt-1" />
              <div>
                <h3 className="text-lg font-bold text-primary mb-4">ما هي ملفات تعريف الارتباط؟</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <h4 className="font-bold text-primary mb-3">أنواع ملفات تعريف الارتباط التي نستخدمها:</h4>
        ...
        <div className="bg-primary rounded-xl p-8 text-white text-center">
          ...
          <div className="flex gap-4 justify-center">
            <button className="bg-white text-primary px-6 py-2 rounded-lg font-medium hover:bg-white/90 transition-colors flex items-center gap-2">

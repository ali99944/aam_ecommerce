...
export default function OrdersPage() {
  ...
  const [ratingDialog, setRatingDialog] = useState<{ isOpen: boolean; order: any }>({ isOpen: false, order: null })
  const [reorderDialog, setReorderDialog] = useState<{ isOpen: boolean; order: any }>({ isOpen: false, order: null })
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-[var(--primary)] mb-2">طلباتي</h1>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 px-4 py-3 rounded text-sm font-medium transition-colors ${
                  activeTab === tab.id ? "bg-[var(--primary)] text-white" : "text-gray-600 hover:text-[var(--primary)]"
                }`}
              >
                {tab.label} ({tab.count})
              </button>
        ...
        {filteredOrders.length === 0 ? (
          <div className="bg-white rounded-lg p-12 text-center">
            ...
            <h2 className="text-xl font-bold text-[var(--primary)] mb-2">لا توجد طلبات</h2>
              ...
              <div key={order.id} className="bg-white rounded-lg p-6 border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <h3 className="font-bold text-[var(--primary)] mb-1">طلب رقم: {order.id}</h3>
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-lg font-bold text-[var(--primary)]">ريال {order.total.toFixed(2)}</p>
                  </div>
                </div>

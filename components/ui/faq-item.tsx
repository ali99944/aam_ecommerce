  ...
  return (
    <div className={`border-b border-gray-200 ${className}`}>
      <button
        ...
        className="w-full flex items-center justify-between py-6 text-right hover:text-primary transition-colors group"
      >
        ...
        <span className="font-semibold text-lg text-primary flex-1 mr-4">{question}</span>
      </button>
      {isOpen && (
